...
func NewEmailService() *EmailService {
	return &EmailService{
		SMTPHost:     os.Getenv("SMTP_HOST"),     // например: smtp.gmail.com
		SMTPPort:     os.Getenv("SMTP_PORT"),     // например: 587
		SMTPUsername: os.Getenv("SMTP_USERNAME"), // ваш email
		SMTPPassword: os.Getenv("SMTP_PASSWORD"), // пароль приложения
		FromEmail:    os.Getenv("FROM_EMAIL"),    // email отправителя
	}
}
